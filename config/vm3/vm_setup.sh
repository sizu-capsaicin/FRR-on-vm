...
sysctl -w net.ipv6.conf.ens161.disable_ipv6=0
sysctl -w net.ipv6.conf.ens161.seg6_enabled=1
sysctl -w net.ipv4.conf.ens161.rp_filter=0
sysctl -w net.ipv6.conf.ens256.disable_ipv6=0
sysctl -w net.ipv6.conf.ens256.seg6_enabled=1
